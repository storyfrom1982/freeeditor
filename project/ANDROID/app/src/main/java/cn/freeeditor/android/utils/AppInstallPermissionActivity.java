...
import cn.freeeditor.android.R;

public class AppInstallPermissionActivity extends AppCompatActivity {
    ...
    public interface AppInstallPermissionListener {
    ...
    public static AppInstallPermissionListener sListener;
