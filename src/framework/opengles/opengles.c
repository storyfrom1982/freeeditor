...
static void SetupTextures(opengles_t *gles, const sr_msg_frame_t *frameToRender)
{
...
static void UpdateTextures(opengles_t *gles, const sr_msg_frame_t *frameToRender)
{
	const GLsizei width = frameToRender->width;
	const GLsizei height = frameToRender->height;
...
int opengles_render(opengles_t *gles, const sr_msg_frame_t *frameToRender)
{
